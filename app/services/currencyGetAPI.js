...
var cryptoGet = function($http) {
    var getCurrencyList = function() {
        return $http.get("https://min-api.cryptocompare.com/data/top/totalvolfull?limit=10&tsym=GBP&api_key={ce4b9f2a883bc7972917eb4afc24c564c5937be8f65b859ed038734970f8c7fe}")
